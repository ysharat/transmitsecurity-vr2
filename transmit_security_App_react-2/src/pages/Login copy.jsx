...
export const action =
  ...
  async ({ request }) => {
    ...
    try {
      ...
      // const journeyResponse = await tsPlatform.ido.startJourney("login-emailOTP-success-Jacob", {
      //   additionalParams: { username: "ysharat1@yopmail.com" },
      // });
    ...
    if (serverResp5.journeyStepId === "stepup_method_selection") 
		{
    ...
    <section className="h-screen grid place-items-center">
      ...
      >
        ...
        <FormInput
          ...
          label="email"
          name="username"
          defaultValue="ysharat1@yopmail.com"
        />
        <FormInput
          type="password"
          label="password"
          name="password"
          defaultValue="Popleysai123"
        />
        <div className="mt-4">
